...
internal class RTLLocationManager(
    ...
    companion object {
        ...
        private const val TAG = "RTLLocationManager"
    ...
    fun requestPermission(activity: Activity) {
        ...
        if (!hasFineLocationPermission) {
            ...
            println("[$TAG] Already have location permissions")
    ...
    fun handlePermissionResult(
        ...
        when (requestCode) {
            LOCATION_PERMISSION_REQUEST_CODE -> {
                ...
                println("[$TAG] Foreground location permission: $foregroundGranted")
            ...
            BACKGROUND_LOCATION_PERMISSION_REQUEST_CODE -> {
                ...
                println("[$TAG] Background location permission: $backgroundGranted")
            ...
            NOTIFICATION_PERMISSION_REQUEST_CODE -> {
                ...
                println("[$TAG] Notification permission: $notificationGranted")
            }
        }
    }
    ...
    fun startMonitoring() {
        if (!hasFineLocationPermission) {
            println("[$TAG] Cannot start monitoring: missing fine location permission")
            return
        }
        ...
        println("[$TAG] Started location monitoring")
    }
    ...
    fun stopMonitoring() {
        ...
        println("[$TAG] Stopped location monitoring")
    }
}
